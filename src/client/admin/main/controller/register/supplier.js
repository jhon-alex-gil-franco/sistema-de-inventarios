import {validateEmail,validateDirection,validateTel,validateId,validateName,validateCel,validateDescrip} from "../../helpers/regularExpresions.js";
      ...
      doc.btnRSupplier.addEventListener("click", (e) => {        
        try {
          if (
            ...
            ValidateIfExist(`${url}supplier/${doc.id.value}`).then((res) => {
              if (res==="Void") {
                const data = {
